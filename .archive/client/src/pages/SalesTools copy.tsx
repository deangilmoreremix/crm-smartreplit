        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 text-lg">
              Our integrated sales tools help you communicate more effectively, close more deals,
        ...
        {tools.map((tool, index) => (
          ...
          >
            <div className="flex flex-col h-full">
              <div
                className="mb-4 p-4 rounded-2xl bg-gradient-to-r transition-all duration-300 group-hover:scale-105 group-hover:shadow-sm"
