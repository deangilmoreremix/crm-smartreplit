      ...
      <header className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Target prospects by location and generate neighborhood insights
          </p>
        </div>
      </header>
        ...
        <div className="lg:col-span-1">
          ...
          {aiInsight && (
            <div className="bg-blue-50 rounded-lg shadow-sm p-6 border border-blue-100">
              ...
              <div className="text-sm text-gray-800 whitespace-pre-line">{aiInsight}</div>
            </div>
          )}
        </div>
                      ...
                      <tr key={prospect.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            ${prospect.homeValue?.toLocaleString()}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            ${prospect.mortgageAmount?.toLocaleString()}
                          </div>
                          <div className="text-xs text-gray-500">
                            Last refi: {prospect.lastRefinance}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              getMarkerColor(prospect.score) === 'green'
                                ? 'bg-green-100 text-green-800'
                                : getMarkerColor(prospect.score) === 'blue'
                                  ? 'bg-blue-100 text-blue-800'
                                  : getMarkerColor(prospect.score) === 'orange'
