...
const VideoEmail: React.FC = () => {
  ...
  const filters = [
    ...
    { id: 'blur', name: 'Soft Focus', value: 'blur(1px)' },
    {
      id: 'professional',
      name: 'Professional',
      value: 'saturate(110%) brightness(105%) contrast(105%)',
    },
  ];
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <header className="mb-6">
        ...
        <p className="text-gray-600 mt-1">
          Create and send personalized video messages to your contacts
        </p>
      </header>
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-black bg-opacity-70 text-white p-3 rounded-lg max-h-32 overflow-y-auto">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      {talkingPoints.map((point, index) => (
                        <li key={index} className="text-sm talking-point">
                          {point}
                        </li>
                      ))}
                    </ul>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
            ...
            {sentVideos.length > 0 ? (
                  ...
                  >
                    <div className="flex justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-xs text-gray-500">{video.date.toLocaleDateString()}</p>
              ...
              <p className="text-gray-500 text-sm italic">No video emails sent yet</p>
            )}
