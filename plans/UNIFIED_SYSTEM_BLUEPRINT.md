...
3. **agency-agents** - 147 specialized AI agent personalities
...
**Agent Skills**: agency-agents (specialized prompts)
...
- [ ] Create agent skill loader
- [ ] Integrate top 20 agents as AI skills
...
interface UnifiedAIService {
  ...
  // Agency agents
  runAgent(agentId: string, task: string): Promise<AgentResult>;
}
```
