        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
              New Real-time AI Features
            </h2>
            <p className="text-gray-700 text-lg">
              Experience our latest real-time AI capabilities powered by Gemini 2.5 Flash and Pro
              models. Get instant responses, live analysis, and streaming results that feel more
              natural and responsive than ever before.
        ...
        {filteredTools.length > 0 ? (
          filteredTools.map((feature) => (
            <div
              key={feature.id}
              onClick={() =>
                feature.demoId ? handleOpenDemoTool(feature.demoId) : openTool(feature.id)
              }
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <span
                    className={`inline-flex items-center font-medium transition-all duration-300 group-hover:translate-x-1 ${
