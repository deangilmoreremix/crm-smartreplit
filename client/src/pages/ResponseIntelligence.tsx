              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    {fastResponses} responses under 1 hour. Keep up the great momentum with instant
                    notifications.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    {slowResponses} responses took over 24 hours. Set up automated follow-up
                    reminders to improve this.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    Best response times: 9-11 AM and 2-4 PM. Schedule important communications
                ...
                >
                  ...
                  <div className="flex flex-col items-end">
                    {responseLevel === 'fast' ? (
                      ...
                      <Timer className="h-5 w-5 text-yellow-500 mb-1" />
                    ) : (
