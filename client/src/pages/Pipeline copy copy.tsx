  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
                          ...
                          <div className="w-16 bg-gray-200 rounded-full h-1.5 mr-2">
                            <div
                              className={`h-1.5 rounded-full ${
                                deal.stage === 'closed-won'
                                  ? 'bg-green-500'
                                  : deal.probability && deal.probability >= 75
                                    ? 'bg-green-500'
                                    : deal.probability && deal.probability >= 50
                                      ? 'bg-blue-500'
                                      : deal.probability && deal.probability >= 25
                                        ? 'bg-yellow-500'
                                        : 'bg-red-500'
                              }`}
      ...
      {showDealDetail && selectedDeal && (
        <DealDetail dealId={selectedDeal} onClose={handleCloseDealDetail} />
      )}
                ...
                <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewDealData({ ...newDealData, value: parseInt(e.target.value) || 0 })
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={
                        newDealData.dueDate
                          ? new Date(newDealData.dueDate).toISOString().substr(0, 10)
                          : ''
                      }
                      onChange={(e) => {
