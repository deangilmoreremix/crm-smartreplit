              ...
              <ScrollAnimationWrapper animation="fade-up">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                    Try our fully interactive dashboard demo with real-time data and AI-powered
                    insights
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <ScrollAnimationWrapper animation="slide-in" delay={100}>
                  <Link
                    ...
                    className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 flex flex-col hover:border-indigo-300 transform hover:-translate-y-1 animation-fix"
                  >
                    ...
                    <p className="text-gray-600 mb-4 flex-1">
                      Get a context-aware AI assistant that can search your CRM, schedule tasks, and
                      take actions for you.
                    </p>
                    <span className="text-indigo-600 flex items-center mt-auto">
                ...
                <ScrollAnimationWrapper animation="slide-in" delay={200}>
                  <Link
                    ...
                    className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 flex flex-col hover:border-cyan-300 transform hover:-translate-y-1 animation-fix"
                  >
                    ...
                    <p className="text-gray-600 mb-4 flex-1">
                      Analyze documents, competitor materials, and visual content to extract
                      valuable sales intelligence.
                    </p>
                    <span className="text-cyan-600 flex items-center mt-auto">
                      Learn more <ChevronRight className="h-4 w-4 ml-1" />
                    </span>
                  </Link>
                </ScrollAnimationWrapper>
                ...
                <ScrollAnimationWrapper animation="slide-in" delay={300}>
                  <Link
                    ...
                    className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 flex flex-col hover:border-emerald-300 transform hover:-translate-y-1 animation-fix"
                  >
                    ...
                    <p className="text-gray-600 mb-4 flex-1">
                      Create professional product images, diagrams, and marketing visuals for your
                      sales presentations.
                    </p>
                    <span className="text-emerald-600 flex items-center mt-auto">
                      Learn more <ChevronRight className="h-4 w-4 ml-1" />
                    </span>
                  </Link>
                </ScrollAnimationWrapper>
                ...
                <ScrollAnimationWrapper animation="slide-in" delay={400}>
                  <Link
                    ...
                    className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 flex flex-col hover:border-amber-300 transform hover:-translate-y-1 animation-fix"
                  >
                    ...
                    <p className="text-gray-600 mb-4 flex-1">
                      AI that performs real actions in your CRM through natural conversation and
                      function calling.
                    </p>
                    <span className="text-amber-600 flex items-center mt-auto">
                      Learn more <ChevronRight className="h-4 w-4 ml-1" />
                    </span>
                  </Link>
                </ScrollAnimationWrapper>
