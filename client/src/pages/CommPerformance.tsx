                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-3">
                        <ChannelIcon
                          className={`h-5 w-5 ${getChannelColor(metric.channel.split(' ')[0])}`}
                        />
                        <div>
                          <h4
                          ...
                          <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                            {metric.conversions} conversions • Avg deal:{' '}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {monthlyTrends.map((trend, index) => (
                ...
                >
                  ...
                  <div className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>ROI</div>
              ...
              return (
                <div key={index} className="flex items-center space-x-3">
                  <div className="flex items-center space-x-3 flex-1">
                    <Avatar size="sm" fallback={getInitials(item.contact)} />
                    <div>
                      <p
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    Your communication ROI of {roi}% significantly exceeds industry average of 400%.
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    Email campaigns show highest ROI at 1306%. Scale this channel for maximum
                    impact.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    Social media ROI of 233% has room for improvement. Consider A/B testing content
                    strategies.
                  </p>
                </div>
              </div>
