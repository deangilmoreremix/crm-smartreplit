          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Get a clear view of your entire sales process with customizable pipelines, accurate
                forecasting, and AI-powered insights.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/register"
                  className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:shadow-lg transition duration-300"
                >
                  Start Free Trial
                </Link>
                <HashLink
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Better Pipeline, Better Results
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our visual pipeline management tools help you track deals, forecast revenue, and close
              more business.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Drag-and-drop interface for moving deals through customized sales stages with
                complete visibility.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                AI-enhanced forecasting helps you predict revenue with greater accuracy for better
                planning.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Gain insights into deal velocity, conversion rates, and bottlenecks to optimize your
                sales process.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Get a Clear View of Your Entire Sales Process
              </h2>

              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Our customizable Kanban-style pipeline gives you complete visibility into your sales
                funnel, with powerful tools to track and manage deals at every stage.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Create pipelines that match your unique sales process and workflow.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Move deals between stages with simple drag-and-drop actions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      See changes and updates from your team instantly as they happen.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Easily identify which deals need immediate attention.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <Link
                  to="/features/pipeline/visual-management"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center">
                      <button className="px-3 py-1.5 bg-purple-600 text-white text-sm rounded-l-md">
                        Monthly
                      </button>
                      <button className="px-3 py-1.5 bg-gray-200 text-gray-700 text-sm">
                        Quarterly
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 mb-6">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex items-start">
                        ...
                        <p>
                          <strong>28% increase</strong> in pipeline value compared to last quarter
                        </p>
                      </div>
                      <div className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                        <p>
                          <strong>$380K likely to close</strong> based on deal progression patterns
                        </p>
                      </div>
                      <div className="flex items-start">
                        <Filter className="h-4 w-4 text-blue-500 mr-2 mt-0.5" />
                        <p>
                          <strong>Focus on Enterprise Licensing deals</strong> for highest close
                          probability
                        </p>
                      </div>
                    </div>
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2">
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Our AI-powered forecasting helps you predict future revenue with greater accuracy,
                so you can plan and make better business decisions.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      AI algorithms analyze historical data to predict future sales with high
                      accuracy.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get realistic forecasts based on each deal's probability of closing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Model different scenarios to understand potential outcomes and risks.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Identify patterns and trends to improve your sales strategy.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <Link
                  to="/features/pipeline/forecasting"
                  className="px-8 py-3 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors mr-4"
                >
                  Learn More
                </Link>
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get deeper insights into your deals and sales performance to continuously improve your
              results.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Track key metrics like win rates, average deal size, sales cycle length, and
              ...
              <Link
                to="/features/pipeline/analytics"
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Automatically identify deals at risk and get AI-powered recommendations to keep
              ...
              <Link
                to="/features/pipeline/deal-health"
            ...
            <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-8">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl shadow-xl p-8 text-white relative">
                ...
                <p className="text-xl mb-6 relative z-10">
                  Smart CRM's pipeline management has transformed how we track and close deals. The
                  visual interface makes it easy to see exactly where every opportunity stands, and
                  the AI forecasting has improved our revenue predictions by 26%.
                </p>
                <div className="flex items-center">
                  <img
                ...
                <div className="absolute -bottom-4 -right-4 text-blue-600 text-6xl opacity-20">
                  "
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl opacity-90 mb-8">
              Join thousands of sales teams using Smart CRM to visualize, manage, and optimize their
              sales pipeline.
            </p>
            <Link
              to="/register"
              className="px-8 py-4 bg-white text-blue-700 font-medium rounded-lg hover:shadow-lg transition duration-300 inline-block"
            >
