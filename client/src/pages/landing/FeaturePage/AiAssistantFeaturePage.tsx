          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Meet your context-aware AI assistant that remembers every conversation, understands
                your sales process, and takes action to help you close more deals faster.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/register"
                  className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-lg hover:shadow-lg transition duration-300"
                >
                  Start Free Trial
                </Link>
                <HashLink
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm text-gray-600">
                          You: "Schedule a follow-up with TechCorp next Tuesday"
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 bg-gray-50 rounded-lg p-3">
                        <p className="text-sm text-gray-800">
                          I've scheduled a follow-up meeting with TechCorp for next Tuesday at 2 PM.
                          I've also prepared talking points based on your previous conversations and
                          added a reminder to your calendar.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Your AI assistant understands context, learns from your interactions, and takes
              meaningful actions to accelerate your sales process.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Automate routine tasks and get instant answers to complex questions, freeing up time
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Never miss a follow-up or opportunity with intelligent reminders and contextual
                recommendations.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get immediate analysis of deals, contacts, and opportunities with natural language
                queries.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/register"
              className="px-8 py-4 bg-white text-indigo-700 font-medium rounded-lg hover:shadow-lg transition duration-300"
            >
              Start Your Free Trial
            </Link>
            <Link
              to="/features"
              className="px-8 py-4 bg-indigo-500 bg-opacity-30 hover:bg-opacity-40 text-white font-medium rounded-lg transition-colors"
            >
