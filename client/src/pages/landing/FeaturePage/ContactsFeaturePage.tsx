          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Organize all your contacts, track interactions, and get AI-powered insights to build
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Create rich contact profiles with all relevant information, interaction history, and
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Organize contacts with custom fields, tags, and automated segmentation based on
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Automatically score leads based on engagement, behavior, and profile data to
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Find exactly who you're looking for with powerful search capabilities and
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-100 mb-6">
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start">
                        <span className="h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs mr-2 flex-shrink-0 mt-0.5">
                          1
                        </span>
                        <span>
                          <strong>High-value prospect</strong> based on company size, industry, and
                          position
                        </span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span>
                          <strong>Engagement level:</strong> High (opened 5 emails, visited pricing
                          page 3 times)
                        </span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span>
                          <strong>Decision maker</strong> with budget authority
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs mr-2 flex-shrink-0 mt-0.5">
                        ...
                        <span>
                          <strong>Recommend:</strong> Schedule a demo this week to maintain momentum
                        </span>
                      </li>
                    </ul>
                  </div>
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2">
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Our AI automatically analyzes dozens of data points to identify your hottest leads
                and opportunities, so you can prioritize effectively.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Score leads based on likelihood to convert using machine learning algorithms.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Automatically track interactions across email, calls, and website activity.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get AI-suggested next actions for each contact to move relationships forward.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Enhance contact profiles with company data, social insights, and more.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Send personalized emails directly from contact records with templates, tracking, and
                scheduling.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                See a chronological history of all interactions with each contact in one unified
                view.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "The contact management in Smart CRM has completely transformed how we track and
                engage with prospects. The AI lead scoring is like having a sales assistant that
                never sleeps."
              </p>
              <div className="flex items-center">
                <img
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "The ability to track all interactions in one place and get AI insights on which
                leads to prioritize has boosted our team's productivity by at least 30%. It's been a
                game-changer."
              </p>
              <div className="flex items-center">
                <img
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                "Smart CRM's contact management and segmentation features allow us to organize
                thousands of contacts effortlessly. The AI lead scoring ensures we're always
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl opacity-90 mb-8">
              Join thousands of sales teams who are organizing, tracking, and engaging with their
              contacts more effectively than ever before.
            </p>
            <Link
              to="/register"
