                ...
                {timeSlots.map((timeSlot) => {
                  ...
                  return (
                    <div
                      ...
                      className={`border rounded-lg p-3 ${
                        isTaken
                          ...
                          : selectedSlot && timeSlot === formatTime(selectedSlot)
                    ...
                    >
                      ...
                      {!isTaken && (
                        <div className="mt-2 text-center text-sm text-gray-500">Available</div>
                      )}
                    </div>
                  );
                })}
                  ...
                  <form onSubmit={handleSubmitAppointment}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex space-x-2">
                          <label
                            className={`flex-1 flex items-center justify-center p-2 border rounded-md hover:bg-blue-50 cursor-pointer ${
                    ...
                    <div className="flex">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between">
                          ...
                          <div>
                            <span
                              className={`text-xs px-2 py-0.5 rounded-full ${getStatusBadgeClass(appointment.status)}`}
                            >
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          {appointment.status === 'scheduled' && (
                            <>
                              ...
                              <button
                                onClick={() =>
                                  handleAppointmentStatusChange(appointment.id, 'canceled')
                                }
                          ...
                          {appointment.status === 'scheduled' && (
                            <button
                              onClick={() =>
                                handleAppointmentStatusChange(appointment.id, 'completed')
                              }
            ...
            <div className="px-6 py-4">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <span
                    className={`mt-1 inline-block text-xs px-2 py-0.5 rounded-full ${getStatusBadgeClass(appointmentDetail.status)}`}
                  >
                ...
                <div className="text-right">
                  ...
                  <p className="text-gray-500">
                    {formatTime(appointmentDetail.date)} - {formatTime(appointmentDetail.endDate)}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                    ({formatDuration(appointmentDetail.duration)})
                  </p>
                </div>
              </div>
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  {appointmentDetail.contactEmail && (
                    <div className="flex items-center text-sm text-gray-500 mb-1">
                      ...
                      <a
                        href={`mailto:${appointmentDetail.contactEmail}`}
                  ...
                  {appointmentDetail.contactPhone && (
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <a
                        href={`tel:${appointmentDetail.contactPhone}`}
                        className="hover:text-blue-600"
                      >
                        {appointmentDetail.contactPhone}
                      </a>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg flex justify-between items-center">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700 text-sm">
                        https://meeting.example.com/join/abc123
                      </span>
                    </div>
