  ...
  const tools = [
    {
      ...
      icon: Target,
      description: 'AI-powered deal scoring and insights',
      color: 'blue',
    },
    {
      id: 2,
      ...
      icon: TrendingUp,
      description: 'Predictive revenue analytics',
      color: 'purple',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: BarChart3,
      description: 'Advanced pipeline insights',
      color: 'red',
    },
    {
      id: 6,
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tools.map((tool) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 bg-gradient-to-r from-${tool.color}-500 to-${tool.color}-600 rounded-lg flex items-center justify-center mb-4`}
                >
        ...
        <div className="mt-8 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-8 text-white">
          ...
          <p className="text-lg opacity-90">
            Our AI tools leverage advanced machine learning to help you close more deals, increase
            revenue, and optimize your sales process.
          </p>
        </div>
      </div>
    </div>
