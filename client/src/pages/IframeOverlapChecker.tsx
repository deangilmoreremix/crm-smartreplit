              ...
              <div className="space-y-3">
                {quickFixes.map((fix, index) => (
                  ...
                  >
                    ...
                    <code
                      className={`text-xs mt-1 block ${isDark ? 'text-blue-400' : 'text-blue-600'}`}
                    >
                      {fix.file}
                    </code>
                  </div>
            ...
            >
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <code
                    className={`block mt-1 p-2 rounded ${isDark ? 'bg-gray-900/50 text-gray-300' : 'bg-gray-100 text-gray-700'}`}
                  >
