  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-gray-900' : 'bg-gray-50'} p-6`}>
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Header */}
        <div
          className={`${isDark ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200'} backdrop-blur-xl border rounded-2xl p-6`}
        >
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      <IconComponent
                        className={`h-5 w-5 ${channel.status === 'synced' ? 'text-green-500' : 'text-red-500'}`}
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`text-sm font-medium ${channel.health > 90 ? 'text-green-500' : channel.health > 70 ? 'text-yellow-500' : 'text-red-500'}`}
                      >
                        {channel.health}%
                      </span>
                    </div>
            ...
            {syncInsights.map((insight, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div
                    className={`px-2 py-1 text-xs rounded-full ${getPriorityColor(insight.priority)}`}
                  >
                    {insight.priority}
                  </div>
                </div>
