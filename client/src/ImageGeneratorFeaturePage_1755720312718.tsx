          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Create stunning, professional-quality images for sales presentations, proposals, and
                marketing materials in seconds with our DALL-E powered Image Generator.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/register"
                  className="px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-medium rounded-lg hover:shadow-lg transition duration-300"
                >
                  Start Free Trial
                </Link>
                <HashLink
                  to="#examples"
                  className="px-8 py-4 bg-white text-emerald-600 font-medium rounded-lg border border-emerald-200 hover:border-emerald-300 hover:shadow-md transition duration-300 flex items-center"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Create professional images for every sales and marketing need without design skills or
              expensive software.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Generate high-quality images in seconds just by describing what you want—no design
                skills required.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Choose from different artistic styles, layouts, and color schemes to match your
                brand and message perfectly.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600">
                Create images in various dimensions and aspect ratios, perfect for presentations,
      ...
      <section id="examples" className="py-20 bg-gradient-to-b from-emerald-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See the quality and versatility of our AI-generated images for various sales and
              marketing purposes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Perfect for showcasing your products in professional settings and various
                  environments.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Transform data into visually appealing graphics that tell a compelling story.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              />
              <div className="p-4">
                <span className="text-xs font-medium text-purple-600 bg-purple-100 px-2.5 py-0.5 rounded-full">
                  Presentation
                </span>
                <h3 className="mt-2 font-bold">Presentation Backgrounds</h3>
                <p className="text-sm text-gray-600 mt-1">
                  Create professional, branded backgrounds for your sales presentations.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                1
              </div>
              <h3 className="text-xl font-bold mb-2">Describe Your Image</h3>
              <p className="text-gray-600">
                Enter a detailed description of the image you want to create. The more specific you
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Choose your preferred style, dimensions, and quality settings for the perfect
                result.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Generate your image and download it for immediate use in your presentations, emails,
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our Image Generator goes beyond basic image creation with powerful features for
              professional use.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow-md flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Adjust styles, layouts, colors, and more to match your brand identity perfectly.
                </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Generate a wide variety of visual content for different sales uses.
                </p>
                <ul className="space-y-1">
                  <li className="flex items-center text-sm text-gray-700">
                    <Check size={16} className="text-emerald-500 mr-2 flex-shrink-0" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Flexible export formats make it easy to use your images anywhere.
                </p>
                <ul className="space-y-1">
                  <li className="flex items-center text-sm text-gray-700">
                    <Check size={16} className="text-emerald-500 mr-2 flex-shrink-0" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Share and collaborate on image creation with your team.
                </p>
                <ul className="space-y-1">
                  <li className="flex items-center text-sm text-gray-700">
                    <Check size={16} className="text-emerald-500 mr-2 flex-shrink-0" />
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See how sales teams are using our Image Generator to enhance their presentations and
              materials.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 italic mb-4">
                  "The Image Generator has been a game-changer for our sales presentations. We've
                  cut design costs by 70% and can now create custom visuals for each client meeting
                  in minutes. The quality is professional enough that clients often ask who our
                  designer is!"
                </p>
                <div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-3xl mx-auto">
              Join thousands of sales professionals who are creating stunning visuals in seconds
              with our AI Image Generator.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/register"
                className="px-8 py-4 bg-white text-emerald-700 font-medium rounded-lg hover:shadow-lg transition duration-300"
              >
                Start Your Free Trial
              </Link>
              <Link
                to="/ai-tools"
                className="px-8 py-4 bg-emerald-500 bg-opacity-30 hover:bg-opacity-40 text-white font-medium rounded-lg transition-colors"
              >
