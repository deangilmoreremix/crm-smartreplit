...
const AiAssistantFeaturePage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'overview' | 'functions' | 'customization'>(
    'overview'
  );
    ...
    <div className="bg-white">
      ...
      <section className="relative pt-20 bg-gradient-to-b from-white to-indigo-50">
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Experience the power of a persistent AI assistant that remembers context,
                understands your CRM data, and can take actions on your behalf to save you time and
                close more deals.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/register"
                  className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-medium rounded-lg hover:shadow-lg transition duration-300"
                >
                  Start Free Trial
                </Link>
                <HashLink
                  to="#demo"
                  className="px-8 py-4 bg-white text-indigo-600 font-medium rounded-lg border border-indigo-200 hover:border-indigo-300 hover:shadow-md transition duration-300 flex items-center"
                >
                  ...
                  <div className="h-80 p-4 overflow-y-auto bg-white">
                    <div className="space-y-4">
                      {chatMessages.map((message, index) => (
                        ...
                        >
                          <div
                            className={`max-w-3/4 p-3 rounded-lg ${message.role === 'user' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-800'}`}
                          >
        ...
        <div
          ...
          style={{
            clipPath:
              'polygon(100% 0%, 0% 0%, 0% 100%, 4% 95%, 8% 100%, 12% 95%, 16% 90%, 20% 95%, 24% 100%, 28% 95%, 32% 90%, 36% 95%, 40% 100%, 44% 95%, 48% 90%, 52% 95%, 56% 100%, 60% 95%, 64% 90%, 68% 95%, 72% 100%, 76% 95%, 80% 90%, 84% 95%, 88% 100%, 92% 95%, 96% 90%, 100% 95%)',
          }}
        ></div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our AI Assistant is deeply integrated with your CRM data and can perform real actions
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-gray-600">
                Unlike simple chatbots, our AI Assistant remembers your entire conversation history
                and maintains context across sessions for truly meaningful interactions.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-gray-600">
                Get instant answers about your contacts, deals, and activities without having to
                search through multiple screens or run reports.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-gray-600">
                Create tasks, schedule meetings, update deals, and more—directly through your
      ...
      <section id="demo" className="py-20 bg-gradient-to-b from-indigo-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Watch how our AI Assistant can help you find information, analyze data, and take
              action all in a natural conversation.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden max-w-5xl mx-auto">
            ...
            <div className="p-6">
                    ...
                    <div className="flex items-center justify-center h-full bg-indigo-900">
                      <div className="text-center">
                        {playingDemo ? (
                          ...
                          <div className="space-y-4">
                            <div
                              className="h-20 w-20 mx-auto rounded-full bg-indigo-600 flex items-center justify-center cursor-pointer"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="p-4 border border-gray-200 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600">
                        Ask about contacts, deals, or activities in natural language without hunting
                        through your CRM.
                      </p>
                    </div>
                    ...
                    <div className="p-4 border border-gray-200 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600">
                        Schedule follow-ups, create tasks, and manage your calendar through simple
                        conversation.
                      </p>
                    </div>
                    ...
                    <div className="p-4 border border-gray-200 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600">
                        Receive data-driven recommendations and analysis of your sales performance.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'functions' && (
                <div className="space-y-6">
                  <p className="text-gray-700">
                    Our AI Assistant can perform real actions in your CRM through function calling.
                    This goes beyond just answering questions—it can actually do things for you.
                  </p>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Find records matching various criteria including status, value, name,
                            etc.
                          </p>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Create follow-up tasks, reminders, or schedule meetings.
                          </p>
                          <code className="block mt-1 text-xs bg-gray-100 p-2 rounded text-indigo-700">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Modify deal details, update contact information, or change statuses.
                          </p>
                          <code className="block mt-1 text-xs bg-gray-100 p-2 rounded text-indigo-700">
                            "Move the Acme Inc deal to negotiation stage and update the probability
                            to 60%"
                          </code>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Create emails, meeting agendas, or call scripts based on your CRM data.
                          </p>
                          <code className="block mt-1 text-xs bg-gray-100 p-2 rounded text-indigo-700">
                  ...
                  <div className="relative p-4 border border-indigo-200 rounded-lg bg-indigo-50">
                    ...
                    {showTooltip && (
                      <div className="absolute top-0 right-0 mt-8 mr-4 w-60 p-2 bg-white border border-gray-200 rounded-lg shadow-lg text-xs text-gray-600 z-10">
                        All function calls are securely executed through your CRM with proper
                        authentication and logging.
                      </div>
                    )}
                    <h3 className="font-medium text-indigo-900 mb-2">Security & Control</h3>
                    <p className="text-sm text-indigo-800">
                      You maintain complete control over what functions the AI Assistant can access.
                      Easily enable or disable specific capabilities and set permissions based on
                      user roles.
                    </p>
                  </div>
                </div>
              ...
              {activeTab === 'customization' && (
                <div className="space-y-6">
                  <p className="text-gray-700">
                    Our AI Assistant is highly customizable to match your specific business needs,
                    communication style, and sales process.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-indigo-200 transition-colors">
                      ...
                      <p className="text-sm text-gray-600">
                        Define exactly how your AI Assistant should communicate, what information it
                        should focus on, and your preferred response style.
                      </p>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-indigo-200 transition-colors">
                      ...
                      <p className="text-sm text-gray-600">
                        Connect the AI Assistant to your specific business operations and tools
                        through custom function definitions.
                      </p>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-indigo-200 transition-colors">
                      ...
                      <p className="text-sm text-gray-600">
                        Upload your company documents, product information, and sales materials for
                        the AI to reference during conversations.
                      </p>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-indigo-200 transition-colors">
                      ...
                      <p className="text-sm text-gray-600">
                        Choose between different AI models based on your needs for speed, accuracy,
                  ...
                  <div className="mt-6 bg-gradient-to-r from-indigo-50 via-purple-50 to-violet-50 p-4 rounded-lg border border-indigo-100 relative overflow-hidden">
                    <div className="relative z-10">
                      ...
                      <div className="flex flex-wrap gap-3 mb-3">
                        ...
                        <div className="px-3 py-1 bg-pink-100 text-pink-700 rounded-full text-sm">
                          Meeting Prep
                        </div>
                      ...
                      <p className="text-sm text-indigo-800">
                        Create specialized AI assistants for different roles and tasks within your
                        sales organization.
                      </p>
                    </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="w-full md:w-2/3">
                ...
                <blockquote className="text-gray-700 italic mb-4">
                  "The AI Assistant has completely transformed how our team operates. It's like
                  having an extra team member who works 24/7, helping us identify opportunities,
                  manage our pipeline, and stay on top of follow-ups. The most impressive part is
                  how it accesses our CRM data and can take actions for us."
                </blockquote>
                <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Ask for information in natural language and get precisely what you need without
                  navigating complex CRM screens.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Find deals by value, stage, or probability
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Look up contact details and interaction history
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Identify overdue tasks and upcoming meetings
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Create and manage your tasks and appointments through simple conversations with
                  your AI Assistant.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Create follow-up tasks with natural language
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Update deals, move them through your pipeline, and get insights on what actions to
                  take next.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Update deal stages and values with a simple message
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Get AI-powered recommendations on next steps
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Identify deals at risk or with high closing potential
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Get personalized sales coaching, objection handling help, and performance
                  insights.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Ask for help with specific customer objections
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Receive personalized performance insights
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="text-green-500 mr-2 flex-shrink-0" />
                    <span className="text-sm text-gray-700">
                      Get strategic advice on complex deals
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <table className="min-w-full bg-white rounded-xl shadow-lg overflow-hidden max-w-4xl mx-auto">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-6 py-4 text-left text-gray-600 font-medium text-sm uppercase tracking-wider">
                    Feature
                  </th>
                  ...
                  <th className="px-6 py-4 text-center text-gray-600 font-medium text-sm uppercase tracking-wider border-l border-gray-200">
                    General-Purpose AI
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                    Can perform actions in your CRM
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-center text-green-600">
                    <Check size={20} />
                  </td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              <div className="relative">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div className="w-16 h-16 rounded-full bg-indigo-600 text-white flex items-center justify-center font-bold text-xl mb-4">
                    1
                  </div>
                  <h3 className="font-bold text-lg mb-2 text-center">Create Your Assistant</h3>
                  <p className="text-gray-600 text-center text-sm">
                    Set up your AI Assistant with a few clicks and customize its name and
                    capabilities.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  <p className="text-gray-600 text-center text-sm">
                    Enable the functions you want your assistant to access and set security
                    parameters.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  <p className="text-gray-600 text-center text-sm">
                    Begin talking to your assistant immediately—no training or complex setup
                    required.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-12 bg-gradient-to-r from-indigo-600 to-violet-600 rounded-xl shadow-xl p-8 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-lg opacity-90 mb-6">
                  Join thousands of sales professionals who are using our AI Assistant to work
                  smarter and close more deals.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Link
                    to="/register"
