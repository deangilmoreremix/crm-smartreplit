          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Discover our Function-Calling AI Assistant that doesn't just answer questions—it
                performs real actions in your CRM to save you time and boost productivity.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/register"
                  className="px-8 py-4 bg-gradient-to-r from-yellow-600 to-amber-600 text-white font-medium rounded-lg hover:shadow-lg transition duration-300"
                >
                  Start Free Trial
                </Link>
                <HashLink
                  to="#features"
                  className="px-8 py-4 bg-white text-amber-600 font-medium rounded-lg border border-amber-200 hover:border-amber-300 hover:shadow-md transition duration-300 flex items-center"
                >
                  ...
                  <div className="p-4">
                    <div className="bg-gray-100 rounded-lg p-4 mb-3">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm text-gray-700">
                          <p>
                            I'm your CRM function assistant. I can help you find information and
                            take actions in your CRM. What would you like to do today?
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-amber-100 rounded-lg p-4 mb-3 ml-auto max-w-[80%]">
                      <p className="text-sm text-gray-800">
                        Find deals that are closing this month
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-100 rounded-lg p-4 mb-3">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm text-gray-700">
                          ...
                          <p className="mt-2">
                            Would you like me to create a follow-up task for any of these deals?
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              What The Function Assistant Can Do
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our Function Assistant goes beyond conversation to perform actual tasks that save you
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Instantly find contacts and deals matching complex criteria through natural language
                queries.
              </p>
              <div className="bg-gray-50 p-3 rounded text-sm text-gray-700">
                <p>
                  <span className="text-amber-800 font-medium">Example:</span> "Find all deals worth
                  over $50,000 in the negotiation stage"
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div className="bg-gray-50 p-3 rounded text-sm text-gray-700">
                <p>
                  <span className="text-amber-800 font-medium">Example:</span> "Schedule a call with
                  Sarah from ABC Corp next Tuesday at 2pm"
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Update deal statuses, contact information, and other CRM data without clicking
                through menus.
              </p>
              <div className="bg-gray-50 p-3 rounded text-sm text-gray-700">
                <p>
                  <span className="text-amber-800 font-medium">Example:</span> "Move the Acme deal
                  to negotiation stage and update the probability to 75%"
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div className="bg-gray-50 p-3 rounded text-sm text-gray-700">
                <p>
                  <span className="text-amber-800 font-medium">Example:</span> "Analyze my pipeline
                  and identify deals at risk of stalling"
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="w-full md:w-1/2 mb-6 md:mb-0">
                ...
                <p className="text-gray-600 mb-6">
                  Watch our Function Assistant in action as it performs real tasks in the CRM based
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover how sales teams are using the Function Assistant to streamline their daily
              workflows.
            </p>
          </div>
          ...
          <div className="mt-12 flex justify-center">
            <Link
              to="/features"
              className="inline-flex items-center px-6 py-3 bg-white border border-amber-300 text-amber-700 hover:bg-amber-50 rounded-lg transition-colors"
            >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We've built our Function Assistant with enterprise-grade security to protect your
              sensitive CRM data.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600">
                Granular control over which functions the AI can access and detailed audit logging
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600">
                All function calls are validated and executed with proper authentication, ensuring
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600">
                Optional confirmation workflow for critical operations, letting users review actions
                before execution.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-yellow-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hear from sales professionals who've transformed their workflow with our Function
              Assistant.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
              ...
              <p className="text-gray-700 italic mb-6">
                "I've cut my CRM data entry time by 75% using the Function Assistant. It's like
                having a personal assistant who understands exactly what I need."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
              ...
              <p className="text-gray-700 italic mb-6">
                "The function-calling capability is what sets this CRM apart. I can update deals,
                schedule meetings, and create tasks all through a simple chat interface."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden mr-3">
                  <img
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
              ...
              <p className="text-gray-700 italic mb-6">
                "As someone who was initially skeptical of AI, I'm now completely sold. The Function
                Assistant has given me back at least 5 hours every week that I can spend on actual
                selling."
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden mr-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="relative">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-amber-600 text-white flex items-center justify-center text-2xl font-bold mb-4">
                  1
                </div>
            ...
            <div className="bg-gradient-to-r from-yellow-600 to-amber-600 rounded-xl shadow-lg overflow-hidden">
              <div className="p-8 text-white">
                ...
                <p className="mb-6 opacity-90 text-lg">
                  Join thousands of sales professionals who are saving time and closing more deals
                  with our AI Function Assistant.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Link
                    to="/register"
                  ...
                  <Link
                    to="/demo"
                    className="px-6 py-3 bg-amber-500 bg-opacity-30 hover:bg-opacity-40 text-white font-medium rounded-md transition-colors"
                  >
                    See Live Demo
                  </Link>
                </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">
                Is the Function Assistant secure?
              </h3>
              <p className="text-gray-700">
                Yes, security is our top priority. All functions are executed with proper
                authentication, permissions are controlled by user roles, and detailed audit logs
                track every action. You maintain complete control over what the assistant can and
                cannot do.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">
                What kind of functions can the assistant perform?
              </h3>
              <p className="text-gray-700">
                The Function Assistant can search for records, create and update deals, add
                contacts, schedule tasks and appointments, generate reports, send notifications, and
                more. The specific functions available depend on your subscription plan.
              </p>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">
                Can I customize what functions are available?
              </h3>
              <p className="text-gray-700">
                Absolutely! You have complete control over which functions are enabled and can
                customize access based on user roles. Enterprise plans also support custom function
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">
                How does the assistant know what to do?
              </h3>
              <p className="text-gray-700">
                The assistant uses advanced natural language processing to understand your requests
                and translate them into the appropriate function calls. It's trained specifically on
                CRM terminology and workflows to ensure accuracy.
              </p>
            </div>
          </div>
