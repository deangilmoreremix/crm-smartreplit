  ...
  const features: Feature[] = [
    {
      ...
      description:
        'Access 20+ AI tools to automate tasks, get insights, and personalize your sales approach.',
    ...
    },
    {
      ...
      description:
        'Organize and track all your contacts, leads, and accounts in one unified database.',
    ...
    },
    {
      ...
      title: 'Deal Pipeline',
      description:
        'Visualize and optimize your sales pipeline with drag-and-drop simplicity and AI insights.',
    ...
    },
    {
      ...
      title: 'AI Assistant',
      description:
        'Work with a context-aware AI assistant that remembers conversations and takes actions for you.',
      icon: <Brain className="h-8 w-8" />,
    ...
    },
    {
      ...
      description:
        'Extract insights from images, documents, competitor materials, and visual content.',
    ...
    },
    {
      ...
      description:
        'Create professional images for presentations, proposals, and marketing materials instantly.',
            ...
            >
              ...
              >
                <div className="flex flex-col h-full">
                  <div
                    className={`p-4 rounded-xl ${feature.iconBg} ${feature.iconColor} w-min mb-6 transform transition-transform duration-500 ${
