  ...
  const features: Feature[] = [
    {
      ...
      description:
        'Get personalized guidance and automation from your AI sales assistant that learns your business.',
      ...
      image:
        'https://images.pexels.com/photos/8370380/pexels-photo-8370380.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    },
    {
      id: 'contact-management',
      title: 'Contact Management',
      description:
        'Organize all your contacts with AI-powered insights, scoring, and recommendations.',
    ...
    },
    {
      ...
      description:
        'Get deep insights into your sales performance with AI-powered analytics and forecasting.',
    ...
    },
    {
      ...
      description:
        'Find exactly what you need with natural language search across all your CRM data.',
      ...
      image:
        'https://images.pexels.com/photos/8370717/pexels-photo-8370717.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    },
    {
      id: 'forecasting',
      title: 'AI Forecasting',
      description:
        'Predict your sales with remarkable accuracy using our advanced AI forecasting engine.',
      ...
      image:
        'https://images.pexels.com/photos/7821874/pexels-photo-7821874.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative order-1 lg:order-2 h-80 md:h-96 animation-fix">
            <div
              className="absolute -inset-4 bg-gradient-to-r from-blue-100/20 to-indigo-100/20 rounded-xl blur-xl transform rotate-3 animate-pulse gpu-accelerated"
            ...
            <div className="relative h-full rounded-xl overflow-hidden shadow-xl border border-gray-100">
              ...
              <div className="absolute top-14 left-4">
                <AnimatedFeatureIcon
                  icon={
                    features[
                      (features.findIndex((f) => f.id === activeFeature) + 1) % features.length
                    ].icon
                  }
                  color={
                    features[
              ...
              <div className="absolute top-8 right-16">
                <AnimatedFeatureIcon
                  icon={
                    features[
                      (features.findIndex((f) => f.id === activeFeature) + 2) % features.length
                    ].icon
                  }
                  color={
                    features[
