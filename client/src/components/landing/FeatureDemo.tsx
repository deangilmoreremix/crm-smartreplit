          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="p-2 bg-white border rounded-md text-sm h-32 overflow-auto">
                ...
                <p className="mb-2">
                  I hope this email finds you well. I wanted to follow up on our conversation last
                  week about the enterprise features you were interested in.
                </p>
                <p className="mb-2">
                  As discussed, our platform offers advanced security features, custom integrations,
                  and dedicated support that would address the challenges you mentioned.
                </p>
                <p className="mb-2">
                  Would you have time for a quick call this week to discuss these features in more
                  detail?
                </p>
                <p className="mb-2">
                  Best regards,
    ...
    <div className={`py-16 ${isDark ? 'bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900' : 'bg-gradient-to-r from-gray-50 via-indigo-50 to-purple-50'}`}>
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-md mx-auto perspective-1000">
          <div
            className={`relative transition-all duration-500 ${isAnimating ? 'opacity-0 scale-95' : 'opacity-100 scale-100'} transform-gpu w-full h-[380px]`}
          >
            {demoFeatures.map((feature) => (
              <div
                key={feature.id}
