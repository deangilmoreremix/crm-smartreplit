  ...
  const slides: DemoSlide[] = [
    {
      ...
      description:
        'Get a complete overview of your sales pipeline with real-time analytics and AI insights',
      image:
    ...
    },
    {
      ...
      description:
        'Prioritize your leads with AI scoring and get personalized engagement recommendations',
      image:
