    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      switch (type) {
        ...
        case 'REQUEST_CONTACTS':
          ...
          const requestIframe = document.getElementById(
            'remote-contacts-iframe'
        ...
        case 'APP_READY':
          ...
          // Send initial data
          const appReadyIframe = document.getElementById(
            'remote-contacts-iframe'
          ) as HTMLIFrameElement;
        ...
        {!isIframeLoaded && (
          <div className="absolute inset-0 flex items-center justify-center bg-gray-50 dark:bg-gray-800 z-10">
            <div className="text-center p-8">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-500">{remoteUrl}</p>
