...
export const UpgradePrompt: React.FC<UpgradePromptProps> = ({
  ...
  if (compact) {
    return (
      <div
        className={`p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg ${className}`}
      >
  ...
  return (
    <Card
      className={`border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 ${className}`}
    >
      <CardHeader className="text-center pb-4">
        <div className="mx-auto w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-4">
          <Crown className="h-6 w-6 text-blue-600" />
        </div>
        <CardTitle className="text-xl text-blue-900">Unlock {featureName || feature}</CardTitle>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-center space-x-4">
          ...
          <div className="text-center">
            <Badge className="mb-2 bg-blue-600">Required Plan</Badge>
        ...
        <p className="text-xs text-center text-blue-600">
          ...
          <a href="mailto:support@smartcrm.vip" className="underline hover:no-underline">
            Contact support
          </a>
        </p>
      </CardContent>
