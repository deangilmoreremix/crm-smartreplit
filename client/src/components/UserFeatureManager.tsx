      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        <div className="flex gap-3">
          ...
          <div className="text-sm text-gray-700 dark:text-gray-300">
            <strong>How it works:</strong> Features with the{' '}
            <Badge variant="outline" className="text-xs text-orange-600 dark:text-orange-400 ml-1">
              Override
            </Badge>{' '}
            badge are custom permissions set specifically for this user. All other features are
            inherited from their product tier.
          </div>
        </div>
      </div>
                    ...
                    <div className="flex-1 min-w-0 pr-4">
                      <div className="flex items-center gap-2 flex-wrap mb-1">
                        ...
                        {feature.source === 'override' && (
                          <Badge
                            variant="outline"
                            className="text-xs bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 border-orange-300 dark:border-orange-700"
                          >
                            Custom Override
                          </Badge>
                        )}
                        {feature.expiresAt && (
                          <Badge
                            variant="outline"
                            className="text-xs bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 border-purple-300 dark:border-purple-700 flex items-center gap-1"
                          >
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      ...
                      {feature.source === 'override' && feature.overrideId && (
                        <Button
                          ...
                          onClick={async () => {
                            try {
                              await removeUserFeature.mutateAsync({
                                userId,
                              ...
                              toast({
                                ...
                                description:
                                  'User will now inherit the default from their product tier.',
                              });
                            } catch (error) {
                              toast({
                                title: 'Error',
