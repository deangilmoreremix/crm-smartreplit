    ...
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        ...
        >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        {isSelected && <CheckCircle size={14} className="text-green-400" />}
                        {badge && (
                          <span
          ...
          {useCase && (
            <div
              className={`p-3 border-t ${isDark ? 'border-white/10 bg-blue-500/5' : 'border-gray-200 bg-blue-50'}`}
            >
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p
                    className={`text-xs font-medium ${isDark ? 'text-blue-300' : 'text-blue-900'}`}
                  >
