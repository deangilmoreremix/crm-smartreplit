...
const RESPONSE_TEMPLATES: ResponseTemplate[] = [
  {
    ...
    prompt:
      'Write a brief follow-up email for {{contact}} who has not responded to my previous message about {{topic}}.',
  },
  {
    id: 'thank-you',
  ...
  },
  {
    ...
    prompt:
      "Write a friendly check-in message to {{contact}} to see how they're doing with {{topic}}.",
  },
];
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {RESPONSE_TEMPLATES.map((template) => (
              ...
              >
                ...
                />
                <span
                  className={`font-medium ${selectedTemplate?.id === template.id ? 'text-teal-700' : 'text-gray-700'}`}
                >
                  {template.title}
                </span>
