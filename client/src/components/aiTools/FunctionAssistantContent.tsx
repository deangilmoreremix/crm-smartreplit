...
const FunctionAssistantContent: React.FC = () => {
    ...
    setMessages([
      {
        ...
        role: 'assistant',
        content:
          "Hello! I'm your AI sales assistant with access to your CRM data. I can help you find contacts, look up deal information, create tasks, and schedule follow-ups. What would you like help with today?",
        timestamp: new Date(),
      },
    ]);
  }, []);
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-indigo-700 mt-1">
              Chat with an AI assistant that can perform actual CRM actions through function
              calling. This assistant can search your data, create tasks, schedule appointments, and
              more.
            </p>
          </div>
        </div>
      ...
      <AIToolContent isLoading={false} error={error} result={null} loadingMessage="" resultTitle="">
        <div className="border border-gray-200 rounded-lg overflow-hidden bg-white">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between p-2 border border-gray-200 rounded hover:bg-white transition-colors">
                  ...
                  <input
                    type="checkbox"
                    checked={
                      enabledFunctions.includes('getContactInfo') &&
                      enabledFunctions.includes('getDealInfo')
                    }
                    onChange={() => {
                      if (enabledFunctions.includes('getContactInfo')) {
                        ...
                        setEnabledFunctions((prev) => [...prev, 'getContactInfo', 'getDealInfo']);
                      }
                    }}
                    className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                  />
          ...
          {showFunctionLogs && (
            <div className="p-3 bg-gray-800 text-gray-200 text-xs font-mono max-h-40 overflow-y-auto">
              <div className="mb-2 text-gray-400 border-b border-gray-700 pb-1">
                ...
                functionLogs.map((log, i) => (
                  <div key={i} className="mb-2">
                    <div className="text-green-400">
                      → {log.name}({JSON.stringify(log.arguments)})
                    </div>
              ...
              >
                ...
                >
                  <div className="flex items-center mb-1">
                    ...
                    <span className="ml-2 text-xs opacity-50">{formatTime(message.timestamp)}</span>
                  </div>
