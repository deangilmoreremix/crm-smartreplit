...
HIGH RISK CUSTOMERS:
${
  prediction.highRiskCustomers
    ?.map(
      (customer: RiskCustomer, index: number) =>
                ...
                {[
                  {
                    key: 'highRisk',
                    label: 'High Risk',
                    value: prediction.metrics.highRisk || 0,
                    color: 'red',
                    icon: AlertTriangle,
                  },
                  {
                    key: 'mediumRisk',
                    label: 'Medium Risk',
                    value: prediction.metrics.mediumRisk || 0,
                    color: 'yellow',
                    icon: TrendingDown,
                  },
                  {
                    key: 'lowRisk',
                    label: 'Low Risk',
                    value: prediction.metrics.lowRisk || 0,
                    color: 'green',
                    icon: Target,
                  },
                  {
                    ...
                    value: prediction.metrics.totalCustomers || 0,
                    color: 'blue',
                    icon: Users,
                  },
                ].map((metric, index) => (
