...
const VoiceAnalysisRealtime: React.FC<VoiceAnalysisRealtimeProps> = ({
  ...
  const simulatedTranscripts = [
    ...
    'Would you be available this Thursday or Friday for a brief meeting with our technical team to address any remaining questions?',
  ];
  ...
  const transcribeAudio = async (blob: Blob) => {
    ...
    try {
      ...
      // For this analysis, we'll use a placeholder
      setTimeout(() => {
        setTranscript(
          'This is a simulated transcript from the recorded audio. In a real implementation, this would be generated by a speech-to-text service.'
        );
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span
                      className={`text-xs font-medium ${
                        liveAnalysis.currentSentiment > 0.3
                          ? 'text-green-600'
                          : liveAnalysis.currentSentiment > -0.3
                            ? 'text-blue-600'
                            : 'text-red-600'
                ...
                <div className="bg-white p-3 rounded border border-indigo-100">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span
                      className={`text-xs font-medium ${
                        liveAnalysis.pacing === 'good'
                          ? 'text-green-600'
                          : liveAnalysis.pacing === 'too fast'
                            ? 'text-yellow-600'
                            : 'text-blue-600'
                      }`}
                    >
                ...
                <div className="bg-white p-3 rounded border border-indigo-100">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-xs font-medium text-indigo-600">
                      {Math.round(liveAnalysis.talkRatio * 100)}% /{' '}
                      {Math.round((1 - liveAnalysis.talkRatio) * 100)}%
                    </span>
                  </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="text-sm text-gray-700 flex items-start">
                    ...
                    Schedule a technical meeting to address remaining concerns
                  </li>
                </ul>
              </div>
            </>
