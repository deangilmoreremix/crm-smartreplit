...
import { useOpenAIStream } from '../../services/openaiStreamService';
...
const StreamingChat: React.FC<StreamingChatProps> = ({
  ...
  const scrollToBottom = () => {
    messagesEndRef.current?.scrollIntoView({
      behavior: typingSpeed === 'instant' ? 'auto' : 'smooth',
    });
  };
            ...
            >
              ...
              >
                <div className="flex items-center mb-1">
                  ...
                  <span className="text-xs ml-2 opacity-50">{formatTime(message.timestamp)}</span>
                </div>
