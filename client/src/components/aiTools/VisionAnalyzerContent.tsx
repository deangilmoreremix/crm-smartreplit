...
const VisionAnalyzerContent: React.FC<VisionAnalyzerContentProps> = ({ type = 'general' }) => {
  ...
  if (type === 'competitor') {
    defaultPrompt =
      "Please analyze this competitor's visual material and provide competitive insights.";
    ...
    description =
      'Extract key information from documents, presentations, or other visual materials.';
  }
