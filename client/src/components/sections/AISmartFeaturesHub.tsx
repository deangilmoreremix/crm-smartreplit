...
const AISmartFeaturesHub: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'insights' | 'controls' | 'performance' | 'tools'>(
    'insights'
  );
  ...
  return (
    <div className="mb-10">
      ...
      <div className="mb-6">
        ...
        {activeTab === 'controls' && (
          <div
            className={`${isDark ? 'bg-white/5 border-white/10' : 'bg-white border-gray-100'} backdrop-blur-xl border rounded-2xl p-6`}
          >
            <SmartAIControls />
          </div>
        )}
        ...
        {activeTab === 'tools' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div
              className={`${isDark ? 'bg-white/5 border-white/10' : 'bg-white border-gray-100'} backdrop-blur-xl border rounded-2xl overflow-hidden`}
            >
              <div
