...
iframe.contentDocument?.head.appendChild(style);
  ...
  return (
    <div
      className={`p-6 ${isDark ? 'bg-gray-800/50' : 'bg-white'} rounded-2xl border ${isDark ? 'border-white/10' : 'border-gray-200'}`}
    >
              ...
              <div className="flex items-start space-x-3">
                <div
                  className={`p-2 rounded-lg ${
                    app.hasOverlapIssue ? 'bg-red-500/20' : 'bg-green-500/20'
                  }`}
                >
                  {app.hasOverlapIssue ? (
              ...
              <div className="text-right">
                <span
                  className={`text-sm font-medium ${
                    app.hasOverlapIssue ? 'text-red-600' : 'text-green-600'
                  }`}
                >
            ...
            {app.hasOverlapIssue && (
              <div className="mt-4">
                <details className="group">
                  <summary
                    className={`cursor-pointer text-sm font-medium ${isDark ? 'text-blue-400' : 'text-blue-600'} hover:underline`}
                  >
                    Show Fix Code
                  </summary>
                  <pre
