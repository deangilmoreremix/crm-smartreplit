        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-start py-6">
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2 max-w-2xl">{appDescription}</p>
              {headerStats && <div className="mt-4">{headerStats}</div>}
            </div>
            {actionButtons.length > 0 && <div className="flex gap-3 ml-6">{actionButtons}</div>}
          </div>
        </div>
      </div>
