      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert business advisor with access to advanced analytics. Generate personalized, strategic greetings that provide actionable insights based on user data. Focus on key opportunities and strategic recommendations.',
        },
        {
          role: 'user',
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert business analyst with advanced mathematical capabilities. Analyze KPI trends and provide strategic insights with confidence intervals and actionable recommendations. Focus on performance forecasting and risk assessment.',
        },
        {
          role: 'user',
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are an expert sales strategist with deep experience in deal analysis. Provide comprehensive deal intelligence including win probability, risk factors, and strategic recommendations based on deal data, contact history, and market context.',
        },
        {
          role: 'user',
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are a senior business consultant with expertise across multiple industries. Generate strategic business intelligence including market insights, competitive advantages, risk factors, growth opportunities, and strategic recommendations.',
        },
        {
          role: 'user',
